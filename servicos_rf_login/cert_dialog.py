...
def selecionar_certificado_no_dialogo(cn: str = "", serial: str = "",
    ...
    if escolhido is None:
        ...
        # Mascarado como no caminho de sucesso: o dialogo lista TODOS os
        # certificados instalados, e o CN de cada um carrega razao social e CNPJ.
        for i, (_, txt) in enumerate(elems):
            print(f"  [el {i}] {_mascarar(txt, 80)}")
        return False
